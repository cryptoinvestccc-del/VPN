	...
	return []Plan{
		{
			...
			Note: "Попробовать без обязательств", CTA: "Взять на месяц",
			Features: []string{
				"Доступ к серверу на 30 дней",
				"Протокол AmneziaWG",
				"Ссылка на подключение сразу после оплаты",
				"Помощь с настройкой в боте",
			},
		},
		{
			...
			Features: []string{
				...
				"Дешевле помесячной оплаты на 17 %",
				"Не нужно продлевать каждый месяц",
				"+14 дней за каждого приглашённого друга",
			},
		},
		{
			ID: "year", Name: "12 месяцев", Price: 900, Currency: "₽", Period: "за год",
			Note: "75 ₽ в месяц — самый дешёвый вариант", CTA: "Взять на год",
			Features: []string{
				"Всё то же, что в месячном",
				"Дешевле помесячной оплаты на 25 %",
