...
export const fallbackPlans: Plan[] = [
  {
    ...
    currency: '₽',
    period: 'за месяц',
    note: 'Чтобы попробовать',
    featured: false,
    cta: 'Взять на месяц',
    features: ['30 дней доступа', 'Один ключ на одно устройство'],
  },
  {
    id: 'half-year',
    name: '6 месяцев',
    ...
    features: ['Экономия 100 ₽', 'Полгода без продлений'],
  },
  {
    id: 'year',
    name: '12 месяцев',
    ...
    currency: '₽',
    period: 'за год',
    note: '75 ₽ в месяц, это 2,5 ₽ в день',
    featured: false,
    cta: 'Взять на год',
    features: ['Экономия 300 ₽', 'Год без продлений'],
  },
]
